...
import typer
from overhood import __version__
...
app = typer.Typer(
    name="overhood",
    help="underhood.club helper package",
...
def version_callback(value: bool):
    ...
    if value:
        console.print(
            f"[yellow]overhood[/] version: [bold blue]{__version__}[/]"
        )
        raise typer.Exit()
...
def main(
    ...
    version: bool = typer.Option(
        ...
        is_eager=True,
        help="Prints the version of the overhood package.",
    ),
):
